...
- (instancetype)initWithNamespace:(NSString *)ns {
    if ((self = [super init])) {
        NSString *fullNamespace = [@"com.mactech.ImageCache122" stringByAppendingString:ns];

        // Create IO serial queue
        _ioQueue = dispatch_queue_create("com.mactech.ImageCache122", DISPATCH_QUEUE_SERIAL);
