...
#define kDefaultSize CGSizeMake(60., 60.)
#define kDefaultCircleCount 9
#define kDefaultCircleWidth 6.
#define kDefaultPeriod 1.8

@implementation MICircleActivity
...
- (void)drawRect:(CGRect)rect;
{
  ...
  for (int i = 0; i < [self circleCount]; i++)
  {
    ...
    CGContextSetFillColorWithColor(context, [[UIColor colorWithWhite:0.7 alpha:alpha] CGColor]);
